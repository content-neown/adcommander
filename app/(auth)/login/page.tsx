...
export default function LoginPage() {
  ...
  return (
    <div className="card-dark p-8 animate-fade-in">
      ...
      <p className="text-slate-400 text-sm mb-8">Sign in to your AdCommander workspace</p>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-xl
                   bg-surface-700 hover:bg-surface-200/10 border border-white/10
                   text-sm font-medium transition-colors mb-6"
      >
